...
from utils.utils import c, P, DP, sigmoid, eps, loss_groups

def federa_proxAL(X0, X1, w0,mu0, beta, rho, r, eps1, eps2):
    n = X0.shape[2]
    ...
    for k in range(K):
        ...
        wk, _  = admm(X0, X1, wk_copy, muk, wk_copy, tauk, rho, beta, r)
